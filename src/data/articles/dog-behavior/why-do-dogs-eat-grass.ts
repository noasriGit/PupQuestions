...
export const whyDoDogsEatGrass: BehaviorArticle = {
  ...
  faqs: [
    {
      ...
      answer:
        "Not necessarily. Many healthy dogs eat grass without becoming ill. Look at the whole picture — vomiting frequency, stool changes, and overall behavior — and consult your vet if something seems off.",
    },
    {
      question: "Should I stop my dog from eating grass?",
      answer:
        "Occasional nibbling on clean, untreated grass is usually fine. Redirect the behavior if it is excessive, if your lawn is treated with chemicals, or if it consistently leads to vomiting.",
    },
    {
      question: "Can eating grass cause blockages?",
      answer:
        "Large amounts of long grass could contribute to digestive irritation in some dogs, but serious blockages from grass alone are uncommon. Contact your vet if your dog vomits repeatedly or shows signs of abdominal pain.",
    },
  ],
  relatedQuestions: [
    {
  ...
  secondaryKeywords: ["dog eating grass vomiting", "is it normal for dogs to eat grass"],
